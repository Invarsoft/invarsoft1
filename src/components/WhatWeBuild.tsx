...
export const servicesData: ServiceItem[] = [
  ...
  },
  {
    ...
    tagline: 'Native iOS & Android mobile apps engineered for speed, offline sync and fluid UX.',
    icon: Smartphone,
    description: 'Bespoke iOS & Android mobile applications built with React Native and Flutter, featuring offline data synchronization, push notifications, and App Store / Google Play publishing.',
    includes: [
      'iOS App Development',
    ...
    deliverables: [
      ...
      'Offline Data Caching & Local Storage Sync',
      'Biometric Auth & Secure Keychain Storage'
    ],
  ...
  },
  {
    ...
    tagline: 'Official WhatsApp Business API bots, automated customer workflows and CRM integration.',
    icon: MessageSquare,
    ...
    includes: [
      ...
      'Automated Chat Bots',
      'CRM Messaging Sync',
      'Broadcasting & Drip Engine',
      'AI Customer Service',
    ],
    deliverables: [
      'Official WhatsApp Business Cloud API Setup',
      '24/7 AI-Powered Conversational Chatbot',
      'Automated Order & Appointment Confirmations',
      'HubSpot & Salesforce CRM Lead Sync',
      'Broadcast Marketing & Drip Campaign Engine'
    ],
    techStack: ['Meta Cloud API', 'Twilio', 'WhatsApp Business', 'Node.js', 'n8n', 'OpenAI'],
    timeline: '1 - 3 Weeks (Depending on complexity)'
  },
  {
    number: '05',
    ...
    <section id="services" className="relative py-28 bg-[#050A0F] text-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
          ...
          >
            From strategy and mobile apps to custom software and WhatsApp automation, we turn ambitious ideas into powerful digital products.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {servicesData.map((service, index) => {
            ...
            return (
              ...
              >
                <div className="h-full rounded-2xl p-7 bg-[#08131C] border border-white/10 backdrop-blur-xl flex flex-col justify-between transition-all duration-300 hover:-translate-y-2 hover:border-cyan-400/50 hover:shadow-[0_0_40px_rgba(0,240,255,0.15)] relative overflow-hidden">
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <div className="p-3 rounded-xl bg-white/5 border border-white/10 text-cyan-400 group-hover:text-black group-hover:bg-cyan-400 group-hover:border-cyan-400 transition-all duration-300">
                    ...
                    {/* Tagline / Description */}
                    <p className="text-slate-300 text-xs leading-relaxed mb-5 font-normal line-clamp-3">
                      {service.tagline}
                    </p>

                    {/* Includes Bullet List */}
                    <div className="space-y-1.5 pt-4 border-t border-white/10">
                      <span className="text-[10px] font-mono tracking-wider text-slate-500 uppercase font-semibold block mb-2">
                        INCLUDES
                      </span>
                  ...
                  <div className="pt-5 mt-5 border-t border-white/5 flex items-center justify-between text-xs font-bold text-slate-400 group-hover:text-cyan-400 transition-colors">
            ...
            >
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-300 text-xs sm:text-base font-normal mt-1">
